...
OUTPUT_FILE = 'pop100.xlsx'
INSTANCES_DIR = 'instances'  

class EvolutionaryLocalSearch:
    def __init__(self, vrptw, iterations=100, population_size=100, local_search_iterations=20):
        self.vrptw = vrptw
...
class GeneticVRPTW:
    def __init__(self, vrptw, population_size=100, generations=100, mutation_rate=0.1, elite_size=5):
        self.vrptw = vrptw
        self.population_size = population_size
